...
from services.media.app.api.v1.router import router
...
app = FastAPI(
    title="Media Service (미디어 서비스)",
    description="Project Dash Media Micro-Service Server - 이미지, CSV, PDF 등의 업로드 및 생성"
)
...
if settings.ALLOWED_ORIGINS:
    ...
    allowed_origins = [
        ...
        "http://localhost:8001",
        "http://localhost:8002",
        "http://localhost:8003",  # Media 서비스 포트
        "http://127.0.0.1:3000",
        "http://127.0.0.1:3001",
        "http://127.0.0.1:5173",
        "http://127.0.0.1:8080",
